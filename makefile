assembler: dynamic_tables.o pre_assembler.o utilities.o assembler.o first_pass.o
	gcc -g -Wall -pedantic -ansi dynamic_tables.o pre_assembler.o utilities.o assembler.o first_pass.o -o assembler
